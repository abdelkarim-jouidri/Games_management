    ...
    <div class=" bg-light  border shadow-lg p-4 rounded vw-25 ">
        <form action="redirect.php" method="POST">
            <div class="form-group">
                ...
                <input type="email" id="email" placeholder="Please enter an Email Adress" name="email" class="w-100 rounded border border-dark" >
            </div>
            <div class="form-group">
            ...
            <input type="submit"  value="Log In" class="btn btn-primary px-3 py-1 font-weight-bold">
